...
export const ONBOARD_MESSAGES = {
  ...
  kifus: [
    <span><b>棋譜を保存</b>　棋譜（KIF/CSA）をファイルか貼り付けで保存できます</span>,
    <span><b><i className="ti ti-record-mail" />棋譜入力</b>　棋譜ファイルが無い対局は、盤に並べて残せます</span>,
    <span><b>戦法タグ</b>　棋譜にも戦法タグを付けられます（ノードと共通）</span>,
    <span>保存した棋譜は、ノード編集画面から研究に取り込めます</span>,
  ],
  // ノード検索画面に初めて来たとき、絞り込み・並び替え・盤面サムネイルを案内する
  search: [
    <span><b>ノード検索</b>　名前・メモ・戦法で、全ツリーのノードをまとめて探せます</span>,
    <span>ステータスや戦法で<b>絞り込み</b>、手ごたえ・好き度・頻度で<b>並び替え</b>。盤面のサムネイルからも探せます</span>,
    <span><b>次にやりたいこと</b>　気になること・対策したいことを書いておくと、ここでまとめて見返せます</span>,
  ],
  map: [
  ...
  node: [
    ...
    // （3枚に分けて流すと、読み終わる前に次へ進んでしまう）
    <span><b>分岐のコツ</b>　分岐は<b>相手がどう来たか</b>で分けます。ほかのコツは子ノードの「ヒント」から</span>,
    <span><b>実戦で当たった相手から選ぶ</b>　棋譜をためると、当たった相手が候補に出ます</span>,
  ],
